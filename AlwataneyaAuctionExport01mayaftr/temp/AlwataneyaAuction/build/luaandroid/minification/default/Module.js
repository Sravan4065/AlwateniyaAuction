...
function calling_service() {
    ...
    mfintegrationsecureinvokerasync(get_refresh_token_inputparam, "ms_user_token", "refresh-token", get_refresh_token_callback);
}
...
function detectFileType(base64) {
    ...
    if (base64.startsWith("data:image/jpeg") || base64.startsWith("/9j/")) {
        ...
        return ".webp";
    } else if (base64.startsWith("data:application/pdf") || base64.startsWith("JVBER")) {
        return ".pdf";
    } else {
        return ".bin";
    }
