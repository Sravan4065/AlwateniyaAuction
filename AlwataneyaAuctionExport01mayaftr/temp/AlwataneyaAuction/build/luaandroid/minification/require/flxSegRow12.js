define("flxSegRow12", function() {
    return function(controller) {
        var flxSegRow12 = new voltmx.ui.FlexContainer({
        ...
        flxSegRow12.setDefaultUnit(voltmx.flex.DP);
        ...
        var flxAutoBidContainer = new voltmx.ui.FlexContainer({
            "autogrowMode": voltmx.flex.AUTOGROW_NONE,
            "centerY": "50%",
            "clipBounds": false,
            "height": "80%",
            "id": "flxAutoBidContainer",
            "isVisible": true,
            "layoutType": voltmx.flex.FREE_FORM,
            "left": "10dp",
            "isModalContainer": false,
        ...
        flxAutoBidContainer.setDefaultUnit(voltmx.flex.DP);
        ...
        var lblAutoBid = new voltmx.ui.Label({
            "bottom": "0dp",
            "centerX": "50%",
            "height": "35%",
            "id": "lblAutoBid",
        ...
        flxAutoBidContainer.add(imgAutoBid, lblAutoBid);
        flxBid.add(flxBidDropDown, flxAutoBidContainer);
        ...
        flxSegRow12.add(flxImg, flxVehicleData);
        return flxSegRow12;
    }
})