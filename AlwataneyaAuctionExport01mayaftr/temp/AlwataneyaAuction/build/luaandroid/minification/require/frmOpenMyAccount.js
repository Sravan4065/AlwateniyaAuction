define("frmOpenMyAccount", function() {
    return function(controller) {
        function addWidgetsfrmOpenMyAccount() {
            ...
            var lblProfile = new voltmx.ui.Label({
                "centerX": "50%",
                "centerY": "50%",
                "id": "lblProfile",
                "isVisible": true,
            ...
            flxHeader.add(flxBackNavigateIcon, lblProfile);
            ...
            var segProfileItems = new voltmx.ui.SegmentedUI2({
                "autogrowMode": voltmx.flex.AUTOGROW_HEIGHT,
                "data": [{
                    "imgChevronRight": "",
                    "lblItemName": "My Documents"
                }, {
                    "imgChevronRight": "",
                    "lblItemName": "WatchList"
                }, {
                    "imgChevronRight": "",
                    "lblItemName": "Saved Searches"
                }, {
                    "imgChevronRight": "",
                    "lblItemName": "Payments"
                }, {
                    "imgChevronRight": "",
                    "lblItemName": "Payment History"
                }, {
                    "imgChevronRight": "",
                    "lblItemName": "Deposits"
                }],
                "groupCells": false,
                "id": "segProfileItems",
                "isVisible": true,
            ...
            flxBody.add(segProfileItems);
            flxMain.add(flxHeader, flxBody);
            this.add(flxMain);
        };
        return [{
            "addWidgets": addWidgetsfrmOpenMyAccount,
