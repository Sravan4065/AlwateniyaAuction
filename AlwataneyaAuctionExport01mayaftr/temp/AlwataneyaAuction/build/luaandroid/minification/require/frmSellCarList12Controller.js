define("userfrmSellCarList12Controller", {
    ...
    getCategories: function() {
        ...
        fry_int_fleet$asset_categories_master_values = mfintegrationsecureinvokerasync(AssetCategoriesMasterValues_inputparam, "fry_int_fleet", "asset-categories-master-values", function(status, response) {
    ...
    submitOnClickAction: function() {
        ...
        addAFleet_inputParam["target_selling_price"] = Number(self.view.tbxTargetSellingPrice.text);
        ...
        ms_fleet$addfleet = mfintegrationsecureinvokerasync(addAFleet_inputParam, "ms_fleet", "addfleet", function(status, response) {
...
define("frmSellCarList12ControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_d64f3b4575ad4ec890ef79d193870449: function AS_FlexContainer_d64f3b4575ad4ec890ef79d193870449(eventobject) {
        var self = this;
        this.view.flxBranchDropdown.setVisibility(true);
    },
    AS_FlexContainer_gb38bfd853764c6f8b3f5153b4fd18aa: function AS_FlexContainer_gb38bfd853764c6f8b3f5153b4fd18aa(eventobject) {
        var self = this;
        this.view.flxCatageryListDropdown.setVisibility(true);
    },
    AS_FlexContainer_b0229c69c21c45f8b5f64854ac4f7b34: function AS_FlexContainer_b0229c69c21c45f8b5f64854ac4f7b34(eventobject) {
        var self = this;
        this.view.flxKeydropdown.setVisibility(true);
    },
    AS_FlexContainer_h235bdc452514bf1970e0fc17defca16: function AS_FlexContainer_h235bdc452514bf1970e0fc17defca16(eventobject) {
        var self = this;
        this.view.flxCatageryListDropdown.setVisibility(true);
    },
    AS_FlexContainer_d6bddd5746f74094ba08f2824241fefa: function AS_FlexContainer_d6bddd5746f74094ba08f2824241fefa(eventobject) {
        var self = this;
        this.view.flxCatageryListDropdown.setVisibility(true);
    },
    AS_FlexContainer_g3faa83d81e34f04a45c33d0b26a16e6: function AS_FlexContainer_g3faa83d81e34f04a45c33d0b26a16e6(eventobject) {
        var self = this;
        this.view.flxSubcatageoryDropdown.setVisibility(true);
    }
});
define("frmSellCarList12Controller", ["userfrmSellCarList12Controller", "frmSellCarList12ControllerActions"], function() {
    var controller = require("userfrmSellCarList12Controller");
    var controllerActions = ["frmSellCarList12ControllerActions"];
