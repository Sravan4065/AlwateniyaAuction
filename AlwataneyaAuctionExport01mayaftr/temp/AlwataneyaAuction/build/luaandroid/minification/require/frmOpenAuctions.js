define("frmOpenAuctions", function() {
    return function(controller) {
        function addWidgetsfrmOpenAuctions() {
            ...
            flxHeader.add(flxBackNavigateIcon, lblAuctions);
            ...
            var segAuctionItems = new voltmx.ui.SegmentedUI2({
                "autogrowMode": voltmx.flex.AUTOGROW_HEIGHT,
                "data": [{
                    "imgChevronRight": "",
                    "lblItemName": "Today's Auction"
                }, {
                    "imgChevronRight": "",
                    "lblItemName": "Auction Calendar"
                }],
                "groupCells": false,
                "id": "segAuctionItems",
                "isVisible": true,
            ...
            flxBody.add(segAuctionItems);
            flxMain.add(flxHeader, flxBody);
            this.add(flxMain);
        };
        return [{
            "addWidgets": addWidgetsfrmOpenAuctions,
