define(function() {
    return function(controller) {
        var Header2Copy1 = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "skin": "CopyslFbox0c276114540c546",
            "top": "0dp",
            "width": "100%",
            "zIndex": 1,
            "appName": "AlwataneyaAuction"
        }, controller.args[0], "Header2Copy1"), extendConfig({
            "paddingInPixel": false
        }, controller.args[1], "Header2Copy1"), extendConfig({}, controller.args[2], "Header2Copy1"));
        Header2Copy1.setDefaultUnit(voltmx.flex.DP);
        var flxHeaderContainer = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "left": "0",
            "isModalContainer": false,
            "skin": "CopyslFbox0fef11607fa354a",
            "top": "0",
            "width": "100%",
            "appName": "AlwataneyaAuction"
        ...
        var flxMenuContainer = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "left": "10dp",
            "isModalContainer": false,
            "skin": "CopysknProfileContainerRound",
            "top": "0",
            "width": "17%",
            "appName": "AlwataneyaAuction"
        ...
        var flxRightHeader = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "isModalContainer": false,
            "right": "0",
            "skin": "CopyslFbox0fc36af2338f444",
            "width": "30%",
            "appName": "AlwataneyaAuction"
        ...
        var flxWishListContainer = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "left": "5dp",
            "isModalContainer": false,
            "skin": "CopyslFbox0e802f5fc710845",
            "top": "0",
            "width": "45%",
            "appName": "AlwataneyaAuction"
        ...
        var flxCountContainer = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "isModalContainer": false,
            "right": "0",
            "skin": "CopyslFbox0bdd6c98ec6da4c",
            "top": "5dp",
            "width": "50%",
            "appName": "AlwataneyaAuction"
        ...
        var flxNotificationContainer = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "isModalContainer": false,
            "right": "0",
            "skin": "CopyslFbox0a2a0b56099764f",
            "width": "45%",
            "appName": "AlwataneyaAuction"
        ...
        var flxNotificationCountContainer = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "isModalContainer": false,
            "right": 3,
            "skin": "CopyslFbox0b1bc460b225640",
            "top": "5dp",
            "width": "50%",
            "appName": "AlwataneyaAuction"
        ...
        Header2Copy1.add(flxHeaderContainer);
        return Header2Copy1;
    }
})