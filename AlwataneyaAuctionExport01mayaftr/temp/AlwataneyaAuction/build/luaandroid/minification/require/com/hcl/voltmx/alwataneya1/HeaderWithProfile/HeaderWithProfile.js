define(function() {
    return function(controller) {
        var HeaderWithProfile = new voltmx.ui.FlexContainer(extendConfig({
            "autogrowMode": voltmx.flex.AUTOGROW_NONE,
            "clipBounds": false,
            "isMaster": true,
            "height": "100dp",
            "id": "HeaderWithProfile",
            "isVisible": true,
            "layoutType": voltmx.flex.FREE_FORM,
            "left": "0dp",
            "isModalContainer": false,
            "skin": "CopyslFbox0ae312ae61ade46",
            "top": "0dp",
            "width": "100%",
            "zIndex": 1,
            "appName": "AlwataneyaAuction"
        }, controller.args[0], "HeaderWithProfile"), extendConfig({
            "paddingInPixel": false
        }, controller.args[1], "HeaderWithProfile"), extendConfig({}, controller.args[2], "HeaderWithProfile"));
        HeaderWithProfile.setDefaultUnit(voltmx.flex.DP);
        ...
        var flxImgContainer = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "left": "0",
            "isModalContainer": false,
            "skin": "CopyslFbox0c07ef789a3434f",
            "top": "0",
            "width": "15%",
            "appName": "AlwataneyaAuction"
        ...
        HeaderWithProfile.add(flxHeader);
