define(function() {
    return function(controller) {
        var Header2 = new voltmx.ui.FlexContainer(extendConfig({
        ...
        }, controller.args[0], "Header2"), extendConfig({
            "paddingInPixel": false
        }, controller.args[1], "Header2"), extendConfig({}, controller.args[2], "Header2"));
        Header2.setDefaultUnit(voltmx.flex.DP);
        ...
        var flxRightHeader = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "isModalContainer": false,
            "right": "0",
            "skin": "sknFlxIconsWishListNotificationsHeader",
            "width": "30%",
            "appName": "AlwataneyaAuction"
        ...
        var flxWishListCountContainer = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "isModalContainer": false,
            "right": "0",
            "skin": "sknFlxCustomRoundMaroonCount",
            "top": "5dp",
            "width": "50%",
            "appName": "AlwataneyaAuction"
        ...
        var txtSearch = new voltmx.ui.TextBox2(extendConfig({
            ...
            "skin": "CopydefTextBoxNormal0b2d7d865769142",
        ...
        Header2.add(flxHead1, flxHeadSearchFilter);
        return Header2;
    }
})