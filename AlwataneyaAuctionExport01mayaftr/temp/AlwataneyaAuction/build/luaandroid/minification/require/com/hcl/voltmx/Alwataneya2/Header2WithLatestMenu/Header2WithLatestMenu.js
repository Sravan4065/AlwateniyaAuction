define(function() {
    return function(controller) {
        var Header2WithLatestMenu = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "preShow": function(eventobject) {
                controller.AS_FlexContainer_fb97040d84c040fdbfbc60397ce47db1(eventobject);
            },
            "skin": "CopyslFbox5",
            "top": "0dp",
            "width": "100%",
        ...
        }, controller.args[0], "Header2WithLatestMenu"), extendConfig({
            "paddingInPixel": false
        }, controller.args[1], "Header2WithLatestMenu"), extendConfig({}, controller.args[2], "Header2WithLatestMenu"));
        Header2WithLatestMenu.setDefaultUnit(voltmx.flex.DP);
        var flxHeaderContainer = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "left": 0,
            "isModalContainer": false,
            "skin": "CopyslFbox0debd2923f7bf41",
            "top": -5,
            "width": "100%",
            "zIndex": 2,
            "appName": "AlwataneyaAuction"
        ...
        var flxMenuContainer = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "left": "10dp",
            "isModalContainer": false,
            "onClick": controller.AS_FlexContainer_fb881cbd70824895adf377e621a838fb,
        ...
        var flxLangChange = new voltmx.ui.FlexContainer(extendConfig({
            "autogrowMode": voltmx.flex.AUTOGROW_NONE,
            "centerY": "50%",
            "clipBounds": false,
            "height": "60%",
            ...
            "width": "30%",
            "appName": "AlwataneyaAuction"
        }, controller.args[0], "flxLangChange"), extendConfig({
            "paddingInPixel": false
        }, controller.args[1], "flxLangChange"), extendConfig({}, controller.args[2], "flxLangChange"));
        flxLangChange.setDefaultUnit(voltmx.flex.DP);
        var btnLangChange = new voltmx.ui.Button(extendConfig({
            "focusSkin": "CopydefBtnFocus0fb5c330af00d44",
            "height": "100%",
            "id": "btnLangChange",
            "isVisible": true,
            "left": "0",
            "skin": "CopydefBtnNormal0c477c9a21ee14a",
            "text": "العربية",
            "top": "0",
            "width": "100%"
        }, controller.args[0], "btnLangChange"), extendConfig({
            "contentAlignment": constants.CONTENT_ALIGN_CENTER,
            "displayText": true,
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnLangChange"), extendConfig({}, controller.args[2], "btnLangChange"));
        flxLangChange.add(btnLangChange);
        flxHeaderContainer.add(flxMenuContainer, flxLogoContainer, flxRightHeader, flxLangChange);
        ...
        var flxImgArrowToggle1 = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "left": "5%",
            "isModalContainer": false,
            "onClick": controller.AS_FlexContainer_d964331b7b9c4dfaa19cdc4cbcf2aea6,
            "skin": "CopyslFbox5",
            "top": "8dp",
            "width": "30dp",
            "appName": "AlwataneyaAuction"
        ...
        var flxImgArrowToggle2 = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "left": "5%",
            "isModalContainer": false,
            "onClick": controller.AS_FlexContainer_f0d6acf4fcf044c6ae3a5bf0f3cdfb72,
            "skin": "CopyslFbox5",
            "top": "8dp",
            "width": "30dp",
            "appName": "AlwataneyaAuction"
        ...
        var flxImgArrowToggle3 = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "left": "5%",
            "isModalContainer": false,
            "onClick": controller.AS_FlexContainer_dcb8069ad13a4e269cf6593e337106a0,
            "skin": "CopyslFbox5",
            "top": "8dp",
            "width": "30dp",
            "appName": "AlwataneyaAuction"
        ...
        var flxImgArrowToggle4 = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "left": "5%",
            "isModalContainer": false,
            "onClick": controller.AS_FlexContainer_aabd68aae39f43e4b721a2f4b53949c6,
            "skin": "CopyslFbox5",
            "top": "8dp",
            "width": "30dp",
            "appName": "AlwataneyaAuction"
        ...
        var flxImgArrowToggle5 = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "left": "5%",
            "isModalContainer": false,
            "onClick": controller.AS_FlexContainer_c3190839c869405f8fd480dd90f3f5f3,
            "skin": "CopyslFbox5",
            "top": "8dp",
            "width": "30dp",
            "appName": "AlwataneyaAuction"
        ...
        var flxContact = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "left": "0",
            "isModalContainer": false,
            "onClick": controller.AS_FlexContainer_c90e5df2ac734d33a6f04daeeadc837d,
            "skin": "sknFlxBasic",
            "top": "15dp",
            "width": "100%",
            "appName": "AlwataneyaAuction"
        ...
        var btnCancel = new voltmx.ui.Button(extendConfig({
            ...
            "isVisible": true,
            "left": "5%",
            "onClick": controller.AS_Button_he20778206274fd78493d012fd9b7523,
        ...
        var btnSubmit = new voltmx.ui.Button(extendConfig({
            ...
            "id": "btnSubmit",
            "isVisible": true,
            "onClick": controller.AS_Button_eddae78cbf4d4748b88675960b05e563,
            "right": "5%",
        ...
        Header2WithLatestMenu.add(flxHeaderContainer, flxMenuBarMain, flxContactPopup, flxFilterFromHeader);
        return Header2WithLatestMenu;
    }
})