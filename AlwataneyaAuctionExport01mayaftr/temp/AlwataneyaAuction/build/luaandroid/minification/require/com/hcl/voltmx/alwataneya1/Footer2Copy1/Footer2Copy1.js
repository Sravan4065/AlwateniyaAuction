define(function() {
    return function(controller) {
        var Footer2Copy1 = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "skin": "CopysknFlxFooter1",
            "width": "100%",
            "zIndex": 1,
            "appName": "AlwataneyaAuction"
        }, controller.args[0], "Footer2Copy1"), extendConfig({
            "paddingInPixel": false
        }, controller.args[1], "Footer2Copy1"), extendConfig({}, controller.args[2], "Footer2Copy1"));
        Footer2Copy1.setDefaultUnit(voltmx.flex.DP);
        var flxHome = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "left": "0",
            "isModalContainer": false,
            "onClick": controller.AS_FlexContainer_e296fd3b620d475e80bf4b45a9a33285,
            "skin": "CopysknflxForm1",
            "top": "0",
            "width": "20%",
            "appName": "AlwataneyaAuction"
        ...
        var imgHome = new voltmx.ui.Image2(extendConfig({
            ...
            "isVisible": true,
            "left": "0dp",
            "skin": "CopyCopyslImage0b958cfc619ba46",
            "src": "home__1_1_3.png",
            "top": "5dp",
            "width": "100%"
        ...
        var lblAuctions = new voltmx.ui.Label(extendConfig({
            ...
            "isVisible": true,
            "left": "0",
            "skin": "CopysknlblCPBoldCapt0b12d29bf562f45",
            "text": "Auctions",
            "textStyle": {
                "letterSpacing": 0,
                "strikeThrough": false
        ...
        var flxSellCar = new voltmx.ui.FlexContainer(extendConfig({
            ...
            "left": "80%",
            "isModalContainer": false,
            "onClick": controller.AS_FlexContainer_f58dd5ddf45b49dd8def926fc6a5edca,
            "skin": "CopysknflxForm1",
            "top": "0",
            "width": "20%",
            "appName": "AlwataneyaAuction"
        ...
        Footer2Copy1.add(flxHome, flxAuctions, flxSearch, flxMyBids, flxSellCar);
        return Footer2Copy1;
    }
})