define("frmOpenBidStatus", function() {
    return function(controller) {
        function addWidgetsfrmOpenBidStatus() {
            ...
            flxHeader.add(flxBackNavigateIcon, lblBidStatus);
            ...
            var segBidStatusItems = new voltmx.ui.SegmentedUI2({
                ...
                "data": [{
                    ...
                    "imgChevronRight": "",
                    "lblItemName": "Approved Vehicles"
                }, {
                    "imgChevronRight": "",
                    "lblItemName": "Rejected Vehicles"
                }, {
                    "imgChevronRight": "",
                    "lblItemName": "Pending Approvals"
                }],
                "groupCells": false,
                "id": "segBidStatusItems",
                "isVisible": true,
                "left": "0",
            ...
            flxBody.add(segBidStatusItems);
            flxMain.add(flxHeader, flxBody);
            this.add(flxMain);
        };
        return [{
            "addWidgets": addWidgetsfrmOpenBidStatus,
