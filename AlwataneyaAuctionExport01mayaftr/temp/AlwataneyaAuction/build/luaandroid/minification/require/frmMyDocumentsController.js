define("userfrmMyDocumentsController", {
    ...
    btnSubmitOnClickAction: function() {
        ...
        if (self.view.btnSubmit.skin === "sknbtnBG61B35CDubaiRegFont45pxRoundedBorder1px") {
            ...
            fry_collection$create_dam_items = mfintegrationsecureinvokerasync(create_dam_items_inputparam, "fry_collection", "create-dam-items", function(status, response) {
...
define("frmMyDocumentsControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
});
define("frmMyDocumentsController", ["userfrmMyDocumentsController", "frmMyDocumentsControllerActions"], function() {
    var controller = require("userfrmMyDocumentsController");
    var controllerActions = ["frmMyDocumentsControllerActions"];
