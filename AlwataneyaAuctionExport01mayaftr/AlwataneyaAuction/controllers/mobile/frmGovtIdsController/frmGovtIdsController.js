...
//   },
  getBase64Data: function() {
  if (
    this.getPreviousForm() === "frmMyDocuments" &&
    this.navigationContext &&
    this.navigationContext._meta_ &&
    this.navigationContext._meta_.widgetId === "btnSubmit" &&
    this.navigationContext._meta_.eventName === "onClick"
  ) {
    this.view.imgUploaded.base64 = this.navigationContext.variable_base64;
