define({ 
  ...
  onNavigate: function(){
    ...
    this.view.btnBookNow.onClick=this.bookNowOnclick.bind(this);
    this.view.preShow = this.onPreShow.bind(this);
    this.view.flxBack.onClick = this.navToDashBaord.bind(this);
  },
...
//     alert("isLogin :"+isLogin);
  ...
  navToDashBaord: function()
  {
    
    new voltmx.mvc.Navigation("frmDashBoard").navigate();
  },
 
  bookNowOnclick: function(){
    
    var nav=new voltmx.mvc.Navigation("frmRequestRoadSideAssistance02");
    nav.navigate();
  }
